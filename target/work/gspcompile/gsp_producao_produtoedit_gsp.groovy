...
class gsp_producao_produtoedit_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(21)
invokeTag('hiddenField','g',31,['name':("version"),'value':(produtoInstance?.version)],-1)
printHtmlPart(22)
...
invokeTag('form','g',38,['url':([resource:produtoInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(25)
})
...
public static final long LAST_MODIFIED = 1446575985041L
