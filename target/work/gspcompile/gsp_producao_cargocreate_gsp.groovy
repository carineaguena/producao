...
class gsp_producao_cargocreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/cargo/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'cargo.label', default: 'Cargo'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',24,['bean':(cargoInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',26,['bean':(cargoInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',34,['url':([resource:cargoInstance, action:'save'])],2)
printHtmlPart(22)
})
