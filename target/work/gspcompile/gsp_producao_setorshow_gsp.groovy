...
class gsp_producao_setorshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/setor/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(14)
if(true && (setorInstance?.nome)) {
printHtmlPart(15)
invokeTag('message','g',29,['code':("setor.nome.label"),'default':("Nome")],-1)
printHtmlPart(16)
invokeTag('fieldValue','g',31,['bean':(setorInstance),'field':("nome")],-1)
printHtmlPart(17)
}
printHtmlPart(18)
createTagBody(2, {->
...
invokeTag('link','g',39,['class':("edit "),'action':("edit"),'resource':(setorInstance)],3)
printHtmlPart(20)
...
invokeTag('form','g',42,['url':([resource:setorInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1446127493693L
