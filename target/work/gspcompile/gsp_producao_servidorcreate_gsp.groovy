...
class gsp_producao_servidorcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/servidor/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'servidor.label', default: 'Servidor'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',24,['bean':(servidorInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',26,['bean':(servidorInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',34,['url':([resource:servidorInstance, action:'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1446161662197L
