...
class gsp_producao_produtocreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',24,['bean':(produtoInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',26,['bean':(produtoInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',34,['url':([resource:produtoInstance, action:'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1446575986512L
