...
class gsp_producao_layoutsmain_gsp extends GroovyPage {
...
printHtmlPart(7)
invokeTag('stylesheet','asset',19,['src':("bootstrap-responsive.css")],-1)
printHtmlPart(7)
invokeTag('stylesheet','asset',20,['src':("bootstrap-responsive.min.css")],-1)
printHtmlPart(1)
invokeTag('javascript','asset',21,['src':("bootstrap.js")],-1)
printHtmlPart(7)
invokeTag('javascript','asset',22,['src':("bootstrap.min.js")],-1)
printHtmlPart(1)
...
printHtmlPart(11)
invokeTag('image','asset',34,['src':("grails_logo.png"),'alt':("Grails")],-1)
printHtmlPart(12)
invokeTag('loginControl','g',37,[:],-1)
printHtmlPart(13)
invokeTag('layoutBody','g',39,[:],-1)
printHtmlPart(14)
expressionOut.print(createLink(uri: '/'))
printHtmlPart(15)
invokeTag('image','asset',45,['src':("etiqueta_rodape2.png"),'alt':("Ifc")],-1)
printHtmlPart(16)
expressionOut.print(createLink(uri: '/'))
printHtmlPart(17)
invokeTag('image','asset',46,['src':("BrancoH_80px.jpg"),'alt':("105")],-1)
printHtmlPart(18)
})
...
public static final long LAST_MODIFIED = 1446127493676L
