...
class gsp_producao_usuariocreate_gsp extends GroovyPage {
...
invokeTag('hasErrors','g',26,['bean':(usuarioInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',34,['url':([resource:usuarioInstance, action:'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1446127493697L
