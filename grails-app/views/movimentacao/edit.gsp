...
<html>
	...
	<body>
		...
		<div id="edit-movimentacao" class="content scaffold-edit" role="main" style="padding-left:15px">
			...
			<ul class="errors" role="alert">
				<g:eachError bean="${movimentacaoInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:movimentacaoInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${movimentacaoInstance?.version}" />
				<fieldset class="form">
