...
<html>
	...
	<body>
		...
		<div id="show-solicitacao" class="content scaffold-show" role="main" style="padding-left:15px">
			...
			<ol class="property-list solicitacao">
				...
				<li class="fieldcontain">
					<span id="dataSolicitacao-label" class="property-label"><g:message code="solicitacao.dataSolicitacao.label" default="Data Solicitacao" /></span>
						...
						<span class="property-value" aria-labelledby="dataSolicitacao-label"><g:formatDate format="dd/MM/yyyy" date="${solicitacaoInstance?.dataSolicitacao}" /></span>
